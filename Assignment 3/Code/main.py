...
def get_latest_trained_model_path():
    ...
    """
    latest_run_dir = os.listdir("./Results/galaxies")
    latest_run_dir.sort()
    latest_run_dir = latest_run_dir[-1]
    saved_models_path = "./Results/galaxies/" + latest_run_dir + "/Saved_Models"
    generated_images_path = "./Results/galaxies/" + latest_run_dir + "/Generated_Images"
    tensorboard_path = "./Results/galaxies/" + latest_run_dir + "/Tensorboard"
...
train(z_dim=mc.Z_DIM, batch_size=mc.BATCH_SIZE, n_iter=mc.N_ITERATIONS,learning_rate=mc.LEARNING_RATE, beta1=mc.BETA_1, image_size=mc.IMAGE_SIZE, load=mc.LOAD)
